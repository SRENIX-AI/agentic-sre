...
// VaultPathMissing-class analyzers (OSS + paid).
//
...
// never logged, never returned, never persisted. The interface's
// signature ([]string, not map[string][]byte) enforces this.
//
